package br.com.emersonmorgado.jpa.modelo.dao;
...
public class MovimentacaoDao<T> {
	...
	public List<MediaComData> getMediaDiariaMovimentacoes(){
		String jpql = "select new br.com.emersonmorgado.jpa.modelo.MediaComData(avg(m.valor), day(m.data), month(m.data))"
	...
	public BigDecimal getSomaDasMovimentacoes() {
		...
		TypedQuery<BigDecimal> query = em.createNamedQuery("somaMoviemtacoes", BigDecimal.class);
		return query.getSingleResult();
	}
	
	public Double getMediaMovimentacao() {	
		String jpqlM = "select avg(m.valor) from Movimentacao m";		
		TypedQuery<Double> queryM = em.createQuery(jpqlM, Double.class);
		return queryM.getSingleResult();
	}
}
